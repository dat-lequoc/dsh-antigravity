window.__ModuleLoader__.load({
  ...
  factory(require) {
    ...
    Object.assign(en, {
      ...
      proxy: "Proxy", customProxy: "Use custom proxy", proxyOff: "Default route",
    ...
    Object.assign(zh, {
      ...
      proxy: "代理", customProxy: "使用自定义代理", proxyOff: "默认路由",
    ...
    function AntigravitySettings({ ctx }) {
      ...
      return React.createElement("div", { className: "dsha-wrap" },
        ...
        React.createElement("section", { className: "dsha-card dsha-account-card" },
          ...
          status.authenticated && (quotaGroups.length > 0 || fallbackModelRows.length > 0) && React.createElement("div", { className: "dsha-quota-title" },
            React.createElement("span", null, tr("quota")),
