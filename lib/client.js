...
`;
    ...
    function QuotaRow({ row, accent, t }) {
      ...
      const preciseLabel = knownPercent ? `${percentText(percent)}%` : "—";
      return React.createElement("div", { className: "dsha-row" },
        React.createElement("div", { className: "dsha-rowtop" },
          ...
          React.createElement("span", { className: `dsha-percent${accent === "cyan" ? " dsha-percent-cyan" : ""}` }, preciseLabel),
        ),
        React.createElement("div", { className: "dsha-bar", "aria-label": preciseLabel },
        ...
        React.createElement("div", { className: "dsha-rowbottom" },
          React.createElement("span", { className: "dsha-remaining" }, t ? t("remainingLabel", { percent: wholePercent }) : `${wholePercent}% remaining`),
          React.createElement("span", { className: "dsha-reset" }, resetText(row, t)),
        ),
      );
    }
